...
@section('content')
    ...
    <div class="bootstrap-wrapper" style="margin: 50px 0;">
        <div class="top_div1 right_div_inner">
            <h1><span class="color">Project</span></h1>
            <br/>
                ...
                <div class="col-md-3">
                    <ul>
                        ...
                        @foreach($categories as $category)
                            <li class="nav-submenu-item"><a style="color: #0b0b0b" href="{{ route('site.project.index', ['category_id' => $category->id]) }}">{{ $category->title }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
