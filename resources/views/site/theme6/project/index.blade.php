                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_image ">
                                            <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                                <div class="image_wrapper"><a href="{{ route('site.project.show', ['slug' => $item->slug]) }}"><img class="scale-with-grid" src="{{ $item->image1 ? $item->image1 : asset('image/placeholder.jpg') }}" alt="home_technics_machine2" width="780" height="551" /></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_column  column-margin-20px">
                                            <div class="column_attr">
                                                <h3><a href="{{ route('site.project.show', ['slug' => $item->slug]) }}">{{ $item->title }}</a></h3>
