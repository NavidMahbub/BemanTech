                    ...
                    <div class="col-md-3">
                        <div class="right-box" style="margin-top: 25px;">
                            ...
                            <div class="sidebar-nav">
                                <ul>
                                    <li><a href="{{ route('site.project.index') }}" style="color: #0b0b0b">All</a></li>
                                    @foreach($categories as $category)
                                        <li><a style="color: #0b0b0b" href="{{ route('site.project.index', ['category_id' => $category->id]) }}">{{ $category->title }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
