...
@section('page_title')
    <div class="app-title">
        <div>
            <h1>Portfolio Category List</h1>
        </div>
        <a href="{{ route('admin.portfolio.category.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Portfolio Category</a>
    </div>
@stop
...
@section('script')
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            // delete portfolio_category
            function deletePortfolioCategory(id) {
                service.delete(`portfolio/category/${id}`)
