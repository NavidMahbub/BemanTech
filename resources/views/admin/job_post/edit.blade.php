...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.job.post.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-post"></i>View Job List</a>
    </div>
@stop
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.title" id="title" name="title" type="text" placeholder="Enter title" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span v-bind:style="{ width: prependWidth + 'px' }" class="input-group-text">Description</span>
                                    </div>
                                    <div v-html="formData.description" class="form-control"></div>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.vacancy" id="vacancy" name="vacancy" type="text" placeholder="Enter vacancy" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.salary" id="salary" name="salary" type="text" placeholder="Enter salary" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.company_name" id="company_name" name="company_name" type="text" placeholder="Enter company name" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.country" id="country" name="country" type="text" placeholder="Enter country" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.person_name" id="person_name" name="person_name" type="text" placeholder="Enter person name" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.designation" id="designation" name="designation" type="text" placeholder="Enter designation" class="form-control">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <a class="form-control" :href="formData.attachment">@{{ formData.attachment }}</a>
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input readonly v-model="formData.expiry_date" id="expiry_date" name="expiry_date" type="text" placeholder="Enter expiry_date" class="form-control">
                                </div>
                           ...
                           {{-- <div class="col-md-12">
                                ...
                                <a href="{{ route('admin.job.post.index') }}" class="btn btn-primary pull-right mr-2" type="button"><i class="fa fa-fw fa-lg fa-arrow-circle-left"></i>Cancel</a>
                            </div>--}}
                        </div>
                    </form>
                </div>
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                submitForm: function () {
                    ...
                    // storing job data
                    vm.service.put(`job/post/${vm.dataId}`, vm.formData)
                        .then(function (response) {
