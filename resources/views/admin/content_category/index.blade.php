...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.content.category.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Content Category</a>
    </div>
@stop
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            function deleteContentCategory(id) {
                service.delete(`content/category/${id}`)
