...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.item.category.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Item Category</a>
    </div>
@stop
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            function deleteItemCategory(id) {
                service.delete(`item/category/${id}`)
