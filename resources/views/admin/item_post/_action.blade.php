<a style="z-index: 99999999;" href="{{ route('admin.item.category.post.edit', ['category_id' => Session::get('item_category_id'), 'id' => $data->id]) }}" class="btn btn-primary icon-btn text-white">
