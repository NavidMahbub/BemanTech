...
@section('site_title', 'ItemPost')

@section('page_title')
    <div class="app-title">
        <div>
            <h1>Create {{ $category->title }}</h1>
        </div>
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                submitForm: function () {
                    ...
                    vm.service.post(`item/category/{{Session::get('item_category_id')}}/post`, vm.formData)
                        .then(function (response) {
                            ...
                            vm.formData.item_category_id = '{{Session::get('item_category_id')}}';
                            @if($category->id == 6)
