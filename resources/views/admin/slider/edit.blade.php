...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.slider.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View Slider List</a>
    </div>
@stop
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                submitForm: function () {
                    ...
                    // storing slider data
                    vm.service.put(`slider/${vm.dataId}`, vm.formData)
                        .then(function (response) {
