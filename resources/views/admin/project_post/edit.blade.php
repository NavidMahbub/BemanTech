...
@section('site_title', 'Project Post')

@section('page_title')
    <div class="app-title">
        <div>
            <h1>Edit Project Post</h1>
        </div>
    ...
    <script type="text/javascript">
        var vueApp = new Vue({
            ...
            mounted: function () {
                ...
                this.getProjectPost(this.dataId);
            ...
            methods: {
                ...
                getProjectPost: function(id) {
                    ...
                    // getting project_post data
                    vm.service.get(`project/post/${id}`)
                        .then(function (response) {
                            ...
                            // set value into form data
                            vm.formData = res.data;

                            vm.$nextTick(function () {
                                vm.activateTexteditor();
                            });

                            vm.formData.body.forEach(function (item, index) {
                                // set body data
                                window.tinyMCE.get('body' + index).setContent(item.value);
                            });
                ...
                submitForm: function () {
                    ...
                    vm.service.put(`project/post/${vm.dataId}`, vm.formData)
                        .then(function (response) {
