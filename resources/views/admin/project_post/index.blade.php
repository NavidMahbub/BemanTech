...
@section('page_title')
    <div class="app-title">
        <div>
            <h1>Project Post List</h1>
        </div>
        <a href="{{ route('admin.project.post.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create ProjectPost</a>
    </div>
@stop
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    // deleting project_post
                    deleteProjectPost(id);
            ...
            function deleteProjectPost(id) {
                service.delete(`project/post/${id}`)
