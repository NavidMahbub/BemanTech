...
@section('site_title', 'Blog Category')
...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.blog.category.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View Blog Category List</a>
    </div>
@stop
                    ...
                    <form v-on:submit.prevent="submitForm()" id="create_form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('admin.blog.category.index') }}" class="btn btn-primary pull-right mr-2" type="button"><i class="fa fa-fw fa-lg fa-arrow-circle-left"></i>Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        new Vue({
            ...
            mounted: function () {
                ...
                // get blog_category data
                this.getBlogCategory(this.dataId);

            },
            methods: {
                // get blog_category data
                getBlogCategory: function(id) {
                    ...
                    // getting blog_category data
                    vm.service.get(`blog/category/${id}`)
                ...
                submitForm: function () {
                    ...
                    // storing blog_category data
                    vm.service.put(`blog/category/${vm.dataId}`, vm.formData)
                        .then(function (response) {
