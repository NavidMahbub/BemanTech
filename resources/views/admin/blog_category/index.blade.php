...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.blog.category.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Blog Category</a>
    </div>
@stop
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            function deleteBlogCategory(id) {
                service.delete(`blog/category/${id}`)
