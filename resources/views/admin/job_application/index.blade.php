...
@section('site_title', 'Job Application')
...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.client.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Job Application</a>
    </div>
@stop
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            function deleteJobApplication(id) {
                service.delete(`job/application/${id}`)
