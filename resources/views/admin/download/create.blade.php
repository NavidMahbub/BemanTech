                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <input v-model="formData.file" id="file" name="file" type="text" placeholder="Enter file" class="form-control" disabled>
                                    <div class="input-group-append">
                                        <a v-on:click="openPopup('{{ asset('admin/plugins/filemanager/dialog.php') }}?type=0&popup=1&field_id=file')" class="btn btn-outline-secondary" type="button">Browse</a>
                                    </div>
                                </div>
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                submitForm: function () {
                    ...
                    vm.service.post('download', vm.formData)
