...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.download.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View Download List</a>
    </div>
@stop
                    ...
                    <form v-on:submit.prevent="submitForm()" id="create_form">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span v-bind:style="{ width: prependWidth + 'px' }" class="input-group-text">File</span>
                                    </div>
                                    <input v-model="formData.file" id="file" name="file" type="text" placeholder="Enter file" class="form-control">
                                </div>
                                <label v-if="errors.file" class="help-block text-danger" style="margin-top: 3px; margin-bottom: 0; padding: 0;">
                                    @{{ errors.file[0] }}
                                </label>
                            </div>
                            <div class="form-group col-md-12">
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                submitForm: function () {
                    ...
                    vm.service.put(`download/${vm.dataId}`, vm.formData)
                        .then(function (response) {
