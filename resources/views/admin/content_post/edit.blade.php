    ...
    <script type="text/javascript">
        var vueApp = new Vue({
            ...
            mounted: function () {
                ...
                // get content_post data
                this.getContentPost(this.dataId);
            ...
            methods: {
                ...
                getContentPost: function(id) {
                    ...
                    // getting content_post data
                    vm.service.get(`content/category/{{Session::get('content_category_id')}}/post/${id}`)
                        .then(function (response) {
                            ...
                            // console.log($('#body').val(vm.formData.body));
                ...
                submitForm: function () {
                    ...
                    vm.service.put(`content/category/{{Session::get('content_category_id')}}/post/${vm.dataId}`, vm.formData)
                        .then(function (response) {
