    ...
    <script type="text/javascript">
        var vueApp = new Vue({
            ...
            mounted: function () {
                ...
                // get portfolio_post data
                this.getPortfolioPost(this.dataId);
            ...
            methods: {
                ...
                getPortfolioPost: function(id) {
                    ...
                    // getting portfolio_post data
                    vm.service.get(`portfolio/post/${id}`)
                        .then(function (response) {
                ...
                submitForm: function () {
                    ...
                    vm.service.put(`portfolio/post/${vm.dataId}`, vm.formData)
                        .then(function (response) {
