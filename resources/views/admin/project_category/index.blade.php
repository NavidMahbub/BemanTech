...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.project.category.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create Project Category</a>
    </div>
@stop
    ...
    <script>
        ...
        $('#dataTableBuilder tbody').on('click', '.delete', function (e) {
            ...
            function deleteProjectCategory(id) {
                service.delete(`project/category/${id}`)
