...
@section('site_title', 'Project Category')
...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.project.category.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View Project Category List</a>
    </div>
@stop
                    ...
                    <form v-on:submit.prevent="submitForm()" id="create_form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('admin.project.category.index') }}" class="btn btn-primary pull-right mr-2" type="button"><i class="fa fa-fw fa-lg fa-arrow-circle-left"></i>Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        new Vue({
            ...
            mounted: function () {
                ...
                // get project_category data
                this.getProjectCategory(this.dataId);

            },
            methods: {
                // get project_category data
                getProjectCategory: function(id) {
                    ...
                    // getting project_category data
                    vm.service.get(`project/category/${id}`)
                ...
                submitForm: function () {
                    ...
                    // storing project_category data
                    vm.service.put(`project/category/${vm.dataId}`, vm.formData)
                        .then(function (response) {
