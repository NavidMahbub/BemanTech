...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.blog.post.index') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-list"></i>View BlogPost List</a>
    </div>
@stop
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <select v-model="formData.blog_category_id" id="blog_category_id"
                                            name="blog_category_id" class="form-control">
                                        <option :key="'blog_category_id'" value="">Select category</option>
                                        <option v-for="(blog_category, index) in blog_categories" :key="'blog_category_id' + index" :value="blog_category.id">
                                            @{{ blog_category.title }}
                                        </option>
                                    </select>
                                </div>
                                <label v-if="errors.blog_category_id" class="help-block text-danger" style="margin-top: 3px; margin-bottom: 0; padding: 0;">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('admin.blog.post.index') }}" class="btn btn-primary pull-right mr-2" type="button"><i class="fa fa-fw fa-lg fa-arrow-circle-left"></i>Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        var vueApp = new Vue({
            ...
            methods: {
                ...
                getBlogCategories: function() {
                    ...
                    vm.service.get(`blog/category`)
                        .then(function (response) {

                            // response
                            let res = response.data;
                            vm.blog_categories = res.data;
                ...
                getBlogPost: function(id) {
                    ...
                    // getting blog_post data
                    vm.service.get(`blog/post/${id}`)
                        .then(function (response) {
                ...
                submitForm: function () {
                    ...
                    // storing blog_post data
                    vm.service.put(`blog/post/${vm.dataId}`, vm.formData)
                        .then(function (response) {
