...
@section('page_title')
    <div class="app-title">
        ...
        <a href="{{ route('admin.blog.post.create') }}" class="btn btn-primary icon-btn text-white"><i class="fa fa-plus-circle"></i>Create BlogPost</a>
    </div>
@stop
