$(document).ready(function () {
    ...
    $("#picture_upload").fileinput({
        ...
        defaultPreviewContent: '<img class="img-fluid" src="' + base_url + 'images/avater.png" alt="Your Avatar" width="200">',
    ...
    //     elErrorContainer: '#kv-avatar-errors-1',
    //     msgErrorClass: 'alert alert-block alert-danger',
    //     // defaultPreviewContent: '<img src="'+ base_url+'images/avater.png" alt="Your Avatar" width="200">',
    ...
    $('#language').on('change', function () {
        ...
        $.ajax({
            type: 'post',
            url: "http://bkspclub.com/en/ajax_change_language",
